    ...
    return (
      <div className="App" >
        ...
        <div className="outer-container">
          ...
          <input type="text" className="input" placeholder="Due Date..." onChange={this.handleNewTaskDate} /> <span className="new-task-button" onClick={this.handleNewTaskAdd}>add new task</span>
        </div>
      </div >
    );
  }
